...
<body>
    ...
    <main class="main">
        ...
        <section id="a-propos" class="child">
            <div class="overlay">
                <p class="p-titre unselectable">
                    <br />
                    Initialement serveur j’ai choisi de découvrir le monde hors de l’univers de la restauration et de me
                    confronter à la vie des entreprises.<br />
                    Fort de cette ouverture au monde, j’ai voulu découvrir le métier d’infographiste;<br />
                    aujourd’hui, je souhaite développer les compétences acquises dans la maitrise de logiciels
                    numériques afin de m’épanouir dans le cadre d’un métier actuel, en constante évolution, qui fait
                    ...
                    <div class="column center-hori center-vert">
                        <div class="sub-blockOverlay column center-vert center-hori unselectable">
                            <div class="block-imgVid row center-vert center-hori">
                                <figure>
                                    <img class="img-overlay1 images" src="images/Capture d’écran 2021-11-27 153205m.jpg" alt="Screenshot du projet" />
                                </figure>
                                <video class="video" width="870" height="490" class="video1" controls autoplay muted loop>
                        ...
                        <div class="sub-blockOverlay column center-vert center-hori unselectable">
                            <div class="block-imgVid row center-vert center-hori">
                                <figure class="figure2">
                                    <img class="img-overlay2 images" src="images/Capture d’écran (11)m.png" alt="Screenshot du projet" />
                                    <p class="p-overlay2">
                                        Projet de groupe.<br />
                                        Maquette du site réalisée avec Figma<br />
                                        (4e page).<br />
                        ...
                        <div class="sub-blockOverlay column center-vert center-hori unselectable">
                            <div class="block-imgVid row center-vert center-hori">
                                <figure class="row center-hori center-vert">
                                    <img class="img-overlay3 images" src="images/Capture d’écran (8).png" alt="Screenshot du projet" />
                                    <img class="img-overlay3 images" src="images/Capture d’écran (12).png" alt="Screenshot du projet" />
                                    <img class="img-overlay3 images" src="images/Capture d’écran (10).png" alt="Screenshot du projet" />
                                </figure>
                                <div>
                                    <video class="video" width="870" height="490" class="video1" controls autoplay muted loop>
        ...
        <section id="contact" class="child">
            ...
            <form class="formContact column center-hori center-vert" method="post">
            ...
            <div class="block-social row center-hori center-vert">
                ...
                <a href="images/CVfigma.png" download class="svg-social linkCV row center-hori center-vert">CV</a>
            </div>
